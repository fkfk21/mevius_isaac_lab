...
class MeviusRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator.sub_terrains["boxes"].grid_height_range = (0.025, 0.2) # (0.025, 0.1)
        ...
        self.rewards.dof_torques_l2.weight = -2.0e-5  # default -1.0e-5, haraduka: -1.0e-3
        self.rewards.dof_acc_l2.weight = -2.0e-9  # default -2.5e-7, haraduka: -1.0e-4
        ...
        self.rewards.dof_pos_limits.weight = -5.0  # default 0.0, haraduka: -10.0
        ...
        self.rewards.feet_stumble.weight = -1.0e-2  # default None, haraduka: None
        self.rewards.gait.weight = 1.0 # default None, haraduka: None
