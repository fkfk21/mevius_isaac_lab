...
It renames all the occurrences of mevius_isaac_lab (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the mevius_isaac_lab folder
        os.rename(
            os.path.join(root_dir_path, "exts", "mevius_isaac_lab", "mevius_isaac_lab"),
            os.path.join(root_dir_path, "exts", "mevius_isaac_lab", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "mevius_isaac_lab"), os.path.join(root_dir_path, "exts", new_name))
